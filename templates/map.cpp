...
map<T1, T2, Alloc>::begin(void) const
{
	...
	return const_iterator(_root, less, _end);
}
...
template <typename T1, typename T2, typename Alloc>
typename map<T1, T2, Alloc>::reverse_iterator
map<T1, T2, Alloc>::rbegin(void)
{
