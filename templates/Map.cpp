template <typename T1, typename T2, typename Alloc> map<T1, T2, Alloc>::map(void) : _root(0), _size(0)
{
	_root = new Node *;
	*_root = 0;
}

template <typename T1, typename T2, typename Alloc> map<T1, T2, Alloc>::~map(void)
{
	_free_tree(*_root);
	delete _root;
}
...
bool
map<T1, T2, Alloc>::empty(void) const
{
	return !_size;
}
...
template <typename T1, typename T2, typename Alloc>
size_t
map<T1, T2, Alloc>::size(void) const
{
	return _size;
}
...
template <typename T1, typename T2, typename Alloc>
pair<T1, T2> &
map<T1, T2, Alloc>::operator[](const T1 &key)
{
...
template <typename T1, typename T2, typename Alloc>
void
map<T1, T2, Alloc>::insert(pair const &pair)
{
...
template <typename T1, typename T2, typename Alloc>
void
map<T1, T2, Alloc>::erase(T1 const &key)
{
	if (RBT_LOG_ERASE)
		print_tree();
...
template <typename T1, typename T2, typename Alloc>
void
map<T1, T2, Alloc>::print_tree(void) const
{
	_print_tree(*_root, 0);
}
...
template <typename T1, typename T2, typename Alloc>
void
map<T1, T2, Alloc>::print(void) const
{
	Node *ptr(*_root);
...
template <typename T1, typename T2, typename Alloc>
void
map<T1, T2, Alloc>::_rotate_del(Node *node)
{
...
template <typename T1, typename T2, typename Alloc>
int
map<T1, T2, Alloc>::_case_0(Node *node, bool deletion)
{
...
template <typename T1, typename T2, typename Alloc>
int
map<T1, T2, Alloc>::_case_1(Node *node, Node *sibling, bool deletion)
{
...
template <typename T1, typename T2, typename Alloc>
int
map<T1, T2, Alloc>::_case_2(Node *node, Node *sibling, bool deletion)
{
...
template <typename T1, typename T2, typename Alloc>
int
map<T1, T2, Alloc>::_case_3(Node *node, Node *sibling, bool deletion)
{
	enum e_side side(node->get_side());
	enum e_side oside(_flip_side(side));
...
template <typename T1, typename T2, typename Alloc>
int
map<T1, T2, Alloc>::_case_4(Node *node, Node *sibling, bool deletion)
{
	enum e_side side(node->get_side());
	enum e_side oside(_flip_side(side));
...
template <typename T1, typename T2, typename Alloc>
void
map<T1, T2, Alloc>::_solve(Node *node, bool deletion)
{
	if (RBT_LOG_ERASE)
...
template <typename T1, typename T2, typename Alloc>
void
map<T1, T2, Alloc>::_erase(Node *node)
{
	if (node == 0)
	{
		if (RBT_LOG_ERASE)
...
template <typename T1, typename T2, typename Alloc>
pair<T1, T2> &
map<T1, T2, Alloc>::_get_reference(const T1 &key)
{
	Node	   *parent;
	Node	   *node;
	enum e_side side;
...
template <typename T1, typename T2, typename Alloc>
void
map<T1, T2, Alloc>::_print_tree(Node *ptr, size_t level) const
{
	if (ptr == 0)
		return;
...
template <typename T1, typename T2, typename Alloc>
void
map<T1, T2, Alloc>::_free_tree(Node *ptr)
{
	if (ptr == 0)
		return;
...
map<T1, T2, Alloc>::_binary_search(T1 const &key) const
{
	Node *parent;
...
template <typename T1, typename T2, typename Alloc>
typename map<T1, T2, Alloc>::Node *
map<T1, T2, Alloc>::_new_node(Node *parent, enum e_side &side)
{
	Node *node;
...
template <typename T1, typename T2, typename Alloc>
void
map<T1, T2, Alloc>::_swap(Node *one, Node *two)
{
	Node	   *onechild[2];
...
template <typename T1, typename T2, typename Alloc>
void
map<T1, T2, Alloc>::_rebalance_tree(Node *node)
{
	if (node == 0)
		return;
...
template <typename T1, typename T2, typename Alloc>
typename map<T1, T2, Alloc>::Node *
map<T1, T2, Alloc>::_rotate(Node *pivot)
{
...
map<T1, T2, Alloc>::_flip_side(enum e_side side) const
{
	if (side == LEFT)
		return RIGHT;
	else
